...
<head>
    ...
    <?php
        $now = new DateTime();
    $getDetUpcoming=DB::table('events')->where('eventDateTime','>=',$now)-> orderBy('eventDateTime','ASC')->get();
    $getDetOld=DB::table('events')->where('eventDateTime','<',$now)-> orderBy('eventDateTime','DESC')->get();
...
<div class="navbar" role="navigation">
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="selected"><a href="{{asset('event')}}">Events</a></li>
            @if (!auth::check())
...
<div class="divider col-sm-10 col-xs-10 col-md-10">
    <div class="header-text" style="color:white"><span>Upcoming Events</span></div>
</div>
...
<section id="clients">
    ...
    <div class="inner team">
        ...
        <div class="team-members inner-details">
            ...
            <!-- Member -->
            @foreach($getDetUpcoming as $showItem)
                <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="0">
                    <div class="member-inner">
                        ...
                        <br>
                        <h3 style="color:white">Venue: {{$showItem->eventVenue}}</h3>
                        <br>
                        <h3 style="color:white">Time: {{$showItem->eventDateTime}}</h3>
...
<div class="divider col-sm-10 col-xs-10 col-md-10">
    <div class="header-text" style="color:white"><span>Past Events</span></div>
</div>
