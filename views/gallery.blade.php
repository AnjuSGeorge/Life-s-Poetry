...
<head>
    ...
    */
    ...
    $getDetails=DB::table('photogallery')->where('photoIsApproved',1)-> orderBy('DateTime','DESC')->get();
...
<div class="navbar" role="navigation">
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="selected"><a href="{{asset('gallery')}}">Gallery</a></li>
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            {{ csrf_field() }}
                <div class="form-group">
                    ...
                    <input type="file" name="fileToUpload" id="fileToUpload" class="btn" style="color:black">
                    </div>
                 </div>
                <div>
                    <br>
                ...
                <div class="form-group">
                    ...
                    <input type="submit" value="Upload Photo" name="submit" class="btn" style="background-color:#5A1F7A;color:black">
                    </div>
                </div>
...
<div class="divider col-sm-12 col-xs-12 col-md-12">
    <h3 style="color:white">Only photos approved by Admin are displayed</h3>
</div>
